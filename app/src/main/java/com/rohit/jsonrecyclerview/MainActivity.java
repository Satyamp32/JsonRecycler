...
public class MainActivity extends AppCompatActivity {
    ...
    String reqUrl = "https://api.myjson.com/bins/rjlgy";
            ...
            if (jsonString != null) {
                try {
                    ...
                    for (int i = 0; i < article.length(); i++) {
                        ...
                        mUser.setId(jsonObject1.getString("name"));
                        mUser.setEmail(jsonObject1.getString("roll"));
                        mUser.setName(jsonObject1.getString("password"));
                        mUserList.add(mUser);
                    }
